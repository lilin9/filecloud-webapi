        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StaticDownloadUrl = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true, comment: "文件的静态下载链接"),
                    ...
                    FileSize_Unit = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Avatar = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false, comment: "用户头像，必须"),
                    ...
                    UserDisk_TotalCapacity_Value = table.Column<double>(type: "float", nullable: false),
                    UserDisk_TotalCapacity_Unit = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserDisk_UsedCapacity_Value = table.Column<double>(type: "float", nullable: false),
                    UserDisk_UsedCapacity_Unit = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserDisk_RemainingCapacity_Value = table.Column<double>(type: "float", nullable: false),
                    UserDisk_RemainingCapacity_Unit = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
